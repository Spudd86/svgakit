...
#include "svgakit/svgaver.h"

/* Release numbers for this release */

static char *copyright_str =
"Copyright (C) 1993-98 SciTech Software Inc, All Rights Reserved.";

static char *release_major = SVGA_RELEASE_MAJOR_STR;
static char *release_minor = SVGA_RELEASE_MINOR_STR;
